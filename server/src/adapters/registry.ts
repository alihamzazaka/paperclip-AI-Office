...
const copilotAdapter: ServerAdapterModule = {
  type: "copilot",
  execute: copilotExecute,
  testEnvironment: copilotTestEnvironment,
  sessionCodec: copilotSessionCodec,
  sessionManagement: getAdapterSessionManagement("copilot") ?? undefined,
